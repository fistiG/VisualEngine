...
class ModchartState 
{
	...
	function callLua(func_name : String, args : Array<Dynamic>, ?type : String) : Dynamic
	{
		...
		if (e != null)
		{
			if (p != null)
				{
					Application.current.window.alert("Luajit Error:\n" + p + "\nHaxe Info: " + e,"Visual Engine Modcharts");
					lua = null;
    ...
    function new()
    {
				...
				if (result != 0)
				{
					Application.current.window.alert("Lua Compiling Error:\n" + Lua.tostring(lua,result),"Visual Engine Modcharts");
					lua = null;
					LoadingState.loadAndSwitchState(new MainMenuState());
				}
