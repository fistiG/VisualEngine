...
class PlayState extends MusicBeatState
{
	...
	var visualEngineWatermark:FlxText;
	...
	override public function create()
	{
		...
		DiscordClient.changePresence(detailsText + " " + SONG.song + " <" + storyDifficultyText + "> " + Ratings.GenerateLetterRank(accuracy), "\nPerfection: " + HelperFunctions.truncateFloat(accuracy, 2) + "% | Game Score: " + songScore + " | Missed: " + misses  , iconRPC);
		#end
		...
		// Add Visual Engine watermark
		visualEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + (Main.watermarks ? " - VE " + MainMenuState.visualEngineVer : ""), 16);
		visualEngineWatermark.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
		visualEngineWatermark.scrollFactor.set();
		add(visualEngineWatermark);

		if (FlxG.save.data.downscroll)
			visualEngineWatermark.y = FlxG.height * 0.9 + 45;
		...
		FlxTween.tween(botPlayState, { alpha: 1 }, 2, options);
		...
		visualEngineWatermark.cameras = [camHUD];
		if (loadRep)
	...
	function startSong():Void
	{
		...
		if (FlxG.save.data.songPosition)
		{
			...
			songPosBar.scrollFactor.set();
			songPosBar.createFilledBar(FlxColor.BLACK, FlxColor.PURPLE);
			add(songPosBar);
	...
	override function openSubState(SubState:FlxSubState)
	{
		if (paused)
		{
			...
			#if windows
			DiscordClient.changePresence("PAUSED on " + SONG.song + " <" + storyDifficultyText + "> " + Ratings.GenerateLetterRank(accuracy), "Perfection: " + HelperFunctions.truncateFloat(accuracy, 2) + "% | Game Score: " + songScore + " | Missed: " + misses  , iconRPC);
			#end
	...
	override function closeSubState()
	{
		if (paused)
		{
			...
			if (startTimer.finished)
			{
				DiscordClient.changePresence(detailsText + " " + SONG.song + " <" + storyDifficultyText + "> " + Ratings.GenerateLetterRank(accuracy), "\nPerfection: " + HelperFunctions.truncateFloat(accuracy, 2) + "% | Game Score: " + songScore + " | Missed: " + misses, iconRPC, true, songLength - Conductor.songPosition);
			}
			else
			{
	...
	override public function update(elapsed:Float)
	{
		...
		if (executeModchart && luaModchart != null && songStarted)
		{
			...
			if (luaModchart.getVar("showOnlyStrums",'bool'))
			{
				...
				visualEngineWatermark.visible = false;
			...
			else
			{
				...
				visualEngineWatermark.visible = true;
	...
	*/
	...
	override function stepHit()
	{
		...
		// Updating Discord Rich Presence (with Time Left)
		DiscordClient.changePresence(detailsText + " " + SONG.song + " <" + storyDifficultyText + "> " + Ratings.GenerateLetterRank(accuracy), "Perfection: " + HelperFunctions.truncateFloat(accuracy, 2) + "% | Game Score: " + songScore + " | Missed: " + misses  , iconRPC,true,  songLength - Conductor.songPosition);
		#end
