...
class ResetChartOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.resetChart = !FlxG.save.data.resetChart;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Reset Chart " + (!FlxG.save.data.resetChart ? "off" : "on");
	}
}

class ReloadChartButton extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.reloadChart = !FlxG.save.data.reloadChart;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Reload Chart " + (!FlxG.save.data.reloadChart ? "off" : "on");
	}
}
...
class MenuButtonsOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.menuButtons = !FlxG.save.data.menuButtons;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Disable Menu Buttons " + (!FlxG.save.data.menuButtons ? "off" : "on");
	}
}